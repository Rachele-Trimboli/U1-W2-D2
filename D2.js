...
}if(age2 >= age1 && age2 >= age3 && age1 >= age3){
    console.log(age2,  age1, age3)
...
let ybis = 13
console.log(xbis % 2) 
// mi da resto 0 quindi è divisibile per 2
console.log(ybis % 2) 
// mi restituisce resto 1 quindi non è divisibile per 2 
...
let val = 7
if (val < 10 && val > 5) {
    console.log("Compreso tra 10 e 5");
  }else if (val < 5) {
    console.log("Meno di 5");
  } else {
    console.log("Uguale a 10 o maggiore");
